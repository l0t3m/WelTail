...
def setup_TestData(filename:str="weltail.db"):
    ...
    db.query("INSERT INTO pets (user_id, species, name, gender, birthDate, race) VALUES ('1', 'cat', 'Hatol', 'male', '2000-01-01', 'Scottish');", filename)
    db.query("INSERT INTO pets (user_id, species, name, gender, birthDate, race) VALUES ('1', 'cat', 'Mini', 'male', '2000-01-01', 'Turkish');", filename)
    db.query("INSERT INTO pets (user_id, species, name, gender, birthDate, race) VALUES ('1', 'dog', 'Koda', 'male', '2000-01-01', 'Samoyed');", filename)
