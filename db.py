...
def setup_TestData():
    ...
    query(f"INSERT INTO activities (user_id, pet_id, type, name, repeat, nextAlert, repeatInterval) VALUES ('1', '2', 'other', '6 hours', 1, '{functions.generate_firstAlert(21600)}', '21600');")
    query(f"INSERT INTO activities (user_id, pet_id, type, name, repeat, nextAlert, repeatInterval) VALUES ('1', '2', 'other', '12 hours', 1, '{functions.generate_firstAlert(43200)}', '43200');")
